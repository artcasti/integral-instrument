...
<header class="header">
   <div class="logo">
    ...
    <a href="http://www.pro-ser.com.ar/demo/cotexa/servicios.php" target="_blank" class="linksitio"><img src="img/web.png" alt="web" class="img__link">Sitio</a>
...
<div class="titulo__pagina">
    <p>Administración de Servicios</p>
</div>
<div class="filtro">
