...
<a  class="home"><img onclick="window.location='pdc_admin.php';" src="img/home.png" alt="home" class="img__link">Home</a>
    <a href="http://www.integralinstrument.com.ar/obras.php" target="_blank" class="linksitio"><img src="img/web.png" alt="web" class="img__link">Sitio</a>
...
<div class="titulo__pagina">
    <p>Administración de Trabajos</p>
</div>
<div class="filtro">
