...
<script src="js/screenfull.js"></script>
    ...
    $('#btn-buscar').click(function () {
       ...
       var filtro = $('#filtro').val(); // get selected value
        ...
        $.get('ajax/detcontactos.php', { idcliente : filtro }, function(resp) {
        $('#tcontacto').html(resp);
        });
      });
    });
...
<div id="wrapper">
    ...
    <div class="justaround">
       <h5>Todos los contactos en la base</h5>
           <div class="filtro">
<!--
...
-->
        ...
        <a href="form_contactos.php" class="btn btn-primary btn-xl" style="margin-top: 0px; margin-right: 0px;">
            <i class="fa fa-plus"></i><span class="hidden-sm hidden-xs">  Agregar Contacto<span/></a>
        </div>    
    </div>
