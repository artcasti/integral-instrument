		...
		<div class="content-top">
			...
			<div class="col-md-4 ">
				...
				<div class="col-md-6 top-content">
					<h5>Equipos en Laboratorio</h5>
					<label><?php echo $equiposingresados[0];  ?></label>
				</div>
				<div class="col-md-6 top-content1">	   
					<div id="demo-pie-1" class="pie-title-center" data-percent="<?php echo $equiposingresados[1];  ?>"> <span class="pie-value"></span> </div>
				</div>
				 <div class="clearfix"> </div>
				</div>
				...
				<div class="content-top-1">
				<div class="col-md-6 top-content">
					<h5>Clientes Incompletos</h5>
					<label><?php  echo $clientesincompletos[2]; ?></label>
				</div>
				<div class="col-md-6 top-content1">	   
					<div id="demo-pie-2" class="pie-title-center" data-percent="<?php echo $clientesincompletos[1];  ?>"> <span class="pie-value"></span> </div>
				</div>
				 <div class="clearfix"> </div>
				</div>
				<div class="content-top-1">
