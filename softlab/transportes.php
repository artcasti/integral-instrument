...
<div id="wrapper">
    ...
    <div class="justaround">
       <h5>Todos los transportes en la base</h5>
        <a href="form_transportes.php" class="btn btn-primary btn-xl" style="margin-top: 0px; margin-right: 0px;">
            <i class="fa fa-plus"></i><span class="hidden-sm hidden-xs">  Agregar Transporte<span/></a>
        </div>    
    </div>
                    <div class="marcotrabajo" id="tcontacto" data-example-id="contextual-table">
						<table class="table" id="powertable">
						  ...
						  <?php
                              ...
                              $resultado = $cm->getListaTransportes();
							...
							<tr class="active">
							  ...
							  <td><a href="form_transportes.php?id=<?php echo $row[0];?>" ><i class="fa fa-edit nav_icon" title="Editar"></i></a>
                              <a href="#" data-href="class/manager_abms.php?accion=eliminatransporte&id=<?php echo $row[0];?>" data-toggle="modal" data-target="#myModalConfirm"><i class="fa fa-trash-o nav_icon" title="Eliminar"></i></a>
							  </td>
							</tr>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>Esta seguro de eliminar el transporte??</p>
				</div>
