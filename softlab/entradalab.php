...
<script src="js/screenfull.js"></script>
    ...
    $(function(){
      ...
      $('#btn-buscar').click(function () {
        ...
        $.get('ajax/detlaboratorio.php', { filtro : filtro }, function(resp) {
        $('#tlaboratorio').html(resp);
        });
      });
    });
...
<div id="wrapper">
 	...
 	<!--banner-->	
		     <div class="banner">
				...
				<span>Equipos en Laboratorio</span>
				</h2>
		    </div>
		<!--//banner-->
    
    <div class="justaround">
       <h5>Todos los equipos en el laboratorio</h5>
           <div class="filtro">
<!--           
        ...
        <a href="form_ingreso.php" class="btn btn-primary btn-xl" style="margin-top: 0px; margin-right: 0px;">
            <i class="fa fa-plus"></i><span class="hidden-sm hidden-xs">  Nuevo Ingreso<span/></a>
        </div>    
    </div>
                    <div class="marcotrabajo" id="tlaboratorio" data-example-id="contextual-table">
						<table class="table" id="powertable">
						  ...
						  <?php
                              ...
                              $resultado = $cm->getOrdenesIngreso($filtro);
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>Esta seguro de deshabilitar el cliente??</p>
				</div>
