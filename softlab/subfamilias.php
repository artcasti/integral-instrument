...
<script src="js/screenfull.js"></script>
    ...
    $(function(){
      ...
      $('#familia').on('change', function () {
        ...
        $.get('ajax/detsubfamilias.php', { idfamilia : filtro }, function(resp) {
        $('#tsubfamilia').html(resp);
        });
      });
    });
...
<div id="wrapper">
 	...
 	<!--banner-->	
		     <div class="banner">
		     		           <div class="alert alert-danger" id="mensaje_error" role="alert" hidden>Error: existen <?php if(isset($_GET['error'])){echo $_GET['error'];} ?> equipos asociadas a esta subfamilia, elimine primero los equipos y luego podrá eliminar la subfamilia</div> 		     
		    	<h1>Subfamilias</h1>
    ...
    <div class="justaround">
       <h5>Todas las subfamilias en la base</h5>
           <div class="filtro">
            <select id="familia" name="familia"  >
            <option value="0">Filtre por familia...</option>
            <?php 

            $cm->carga_selected('familia',$idfamilia,0);
            ?>
            
        <a href="form_subfamilias.php" class="btn btn-primary btn-xl" style="margin-top: 0px; margin-right: 0px;">
            <i class="fa fa-plus"></i><span class="hidden-sm hidden-xs">  Agregar Subfamilia<span/></a>
        </div>    
    </div>
                    <div class="marcotrabajo" id="tsubfamilia" data-example-id="contextual-table">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>Esta seguro de eliminar la subfamilia??</p>
				</div>
