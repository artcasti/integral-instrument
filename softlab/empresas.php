...
<div id="wrapper">
    ...
    <div class="justaround">
       <h5>Empresas en la base</h5>
           <div class="filtro">
        <a href="form_empresas.php" class="btn btn-primary btn-xl" style="margin-top: 0px; margin-right: 0px;">
            <i class="fa fa-plus"></i><span class="hidden-sm hidden-xs"> Agregar Empresa<span/></a>
        </div>    
    </div>
                    <div class="marcotrabajo" id="tclientes" data-example-id="contextual-table">
						<table class="table">
						  ...
						  <?php
                              ...
                              $resultado = $cm->getListaEmpresas();
                              while ($row=$resultado->fetch_array()){ 
                              ?>
							<tr class="active">
							  <th scope="row"><?php echo $row[16];?></th>
							  <td><?php echo $row[2];?></td>
							  <td><?php echo $row[3];?></td>
							  <td><?php echo $row[14];?></td>
							  <td><?php echo $row[6];?></td>
							  <td><a href="form_empresas.php?id=<?php echo $row[0];?>" ><i class="fa fa-edit nav_icon" title="Editar"></i></a>
                              <a href="form_documentos.php?id=<?php echo $row[0];?>&tipo=4"><i class="fa fa-file-pdf-o nav_icon" title="Documentos Asociados"></i></a>
                              <a href="#" data-href="class/manager_abms.php?accion=eliminaempresa&id=<?php echo $row[0];?>" data-toggle="modal" data-target="#myModalConfirm"><i class="fa fa-trash-o nav_icon" title="Eliminar"></i></a>
