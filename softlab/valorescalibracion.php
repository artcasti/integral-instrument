...
<div id="wrapper">
 	...
 	<!--banner-->	
		     <div class="banner">
		    	...
		    	<h1>Valores Calibración</h1>
				<a href="entradalab.php">Laboratorio</a>
				<i class="fa fa-angle-right"></i>
				<span>Valores por familia</span>
				</h2>
		    </div>
		<!--//banner-->
    
    <div class="justaround">
       <h5>Todas las configuraciones en la base</h5>
           <div class="filtro">
                    ...
                    <div class="marcotrabajo" id="tsubfamilia" data-example-id="contextual-table">
						<table class="table" id="powertable">
						  ...
						  <?php
                              ...
                              $resultado = $cm->getListaValoresCalibracion();
							...
							<tr class="active">
							  ...
							  <td><a href="form_confvalores.php?id=<?php echo $row['idfamilia'];?>" ><i class="fa fa-edit accion_icon" title="Editar"></i></a>
                         	  </td>
							</tr>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>Esta seguro de eliminar la configuración??</p>
				</div>
